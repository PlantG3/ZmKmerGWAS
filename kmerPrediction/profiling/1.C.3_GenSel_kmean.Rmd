...
trainfile <- list.files(path="/common/jyanglab/jyang21/projects/Kmer-GS/largedata/kmean/", 
                        pattern="train", full.names=TRUE)
testfile <- list.files(path="/common/jyanglab/jyang21/projects/Kmer-GS/largedata/kmean/", 
...
run_GenSel4(inputdf, cv=TRUE, 
            inpdir="largedata/kmean/", 
            cmdno=1,
            shid = "slurm-script/run_kmean_array.sh", remove=FALSE,
...
trainfile <- list.files(path="/common/jyanglab/jyang21/projects/Kmer-GS/largedata/kmean_nam/", 
                        pattern="train", full.names=TRUE)
testfile <- list.files(path="/common/jyanglab/jyang21/projects/Kmer-GS/largedata/kmean_nam/", 
                      pattern="test", full.names=TRUE)
...
run_GenSel4(inputdf, cv=TRUE, 
            inpdir="largedata/kmean_nam/", 
            cmdno=1,
            shid = "slurm-script/run_knam_array.sh", remove=FALSE,
            email="yangjl0930@gmail.com", 
            runinfo = c(TRUE, "jyanglab", 2, "2G", "8:00:00") )
...
```{r}
f <- list.files(path="/common/jyanglab/jyang21/projects/Kmer-GS/largedata/nam/", 
                pattern="ghatREL", full.names=TRUE)
